...
import com.worldline.bookstore.service.MailService;
import com.worldline.bookstore.service.UserService;
import com.worldline.bookstore.service.dto.UserDTO;
import com.worldline.bookstore.web.rest.vm.ManagedUserVM;
import com.worldline.bookstore.web.rest.util.HeaderUtil;
import com.worldline.bookstore.web.rest.util.PaginationUtil;
...
public class UserResource {
     ...
     *         user,
     *         or with status 400 (Bad Request) if the login or email is already in
     *         use,
    ...
    public ResponseEntity<UserDTO> updateUser(@RequestBody ManagedUserVM managedUserVM) {
        ...
        return ResponseUtil.wrapOrNotFound(updatedUser,
                HeaderUtil.createAlert("A user is updated with identifier " + managedUserVM.getLogin(),
