...
import com.worldline.bookstore.security.jwt.JWTConfigurer;
import com.worldline.bookstore.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			// CORS
			.addFilterBefore(corsFilter, UsernamePasswordAuthenticationFilter.class) // see https://docs.spring.io/spring-security/site/docs/current/reference/html/cors.html
			.exceptionHandling()
		...
		.and()
			...
			.antMatchers("/api/news/like/**").authenticated() 
  ...
  //    	- inline style ... 
	private void setCspConfig(HttpSecurity http) throws Exception {
		...
		.contentSecurityPolicy(
				"script-src" +
						" 'self' 'unsafe-eval' 'sha256-lK+Y3vDnNUrD/ZPLGsnM6B+euoBxZ/MyiIbY2G5VoPw='" +
