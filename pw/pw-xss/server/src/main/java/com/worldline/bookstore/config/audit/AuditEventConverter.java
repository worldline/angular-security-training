package com.worldline.bookstore.config.audit;

import com.worldline.bookstore.domain.PersistentAuditEvent;
...
public class AuditEventConverter {
    ...
    public AuditEvent convertToAuditEvent(Optional<PersistentAuditEvent> persistentAuditEvent) {
        if (persistentAuditEvent.isEmpty()) {
            return null;
        }
        return convertToAuditEvent(persistentAuditEvent.get());
    }
